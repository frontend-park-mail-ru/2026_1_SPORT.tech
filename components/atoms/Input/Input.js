 ...
 * @param {string} config.state - normal | active | error | warning | correct | disabled
...
export async function renderInput(container, config = {}) {
    ...
    const messageEl = field.querySelector('.input-field__message');
    ...
    return {
        ...
        setNormal: () => setState(INPUT_STATES.NORMAL)
    };
}
